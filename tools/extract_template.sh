...
soft='GLPI - MSP Agreement plugin'
version='0.0.1'
email=glpi-translation@gna.org
copyright='Multiconecta Solucoes Informatica'
...
xgettext *.php */*.php -o locales/mspagreement.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
